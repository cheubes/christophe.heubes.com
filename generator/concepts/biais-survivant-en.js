...
module.exports = {
  id:          'biais-survivant-en',
  title:       'Survivorship Bias',
  category:    'Biases & Heuristics',
  tagline:     "We learn from survivors, not from those who disappeared.",
  description: "Cognitive error that consists of focusing on successful cases while ignoring those that failed — invisible by definition.",
  ...
  render(ctx) {
    ...
    <text x="382" y="208" text-anchor="middle"
          ...
          letter-spacing="2.5" fill="${p.muted}" opacity="0.55">WHAT WE OBSERVE</text>
    <text x="820" y="208" text-anchor="middle"
          font-family="Ubuntu, sans-serif" font-weight="500" font-size="14"
          letter-spacing="2.5" fill="${p.muted}" opacity="0.55">REALITY</text>`;
    ...
    <text x="382" y="844" text-anchor="middle"
          ...
          letter-spacing="1.5" fill="${p.gold}" opacity="0.55">VISIBLE</text>
    <text x="820" y="814" text-anchor="middle"
          font-family="Ubuntu, sans-serif" font-weight="700" font-size="52"
          fill="${p.muted}" opacity="0.42">21</text>
    <text x="820" y="844" text-anchor="middle"
          font-family="Ubuntu, sans-serif" font-weight="400" font-size="13"
          letter-spacing="1.5" fill="${p.muted}" opacity="0.30">IN TOTAL</text>`;
