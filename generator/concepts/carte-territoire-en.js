...
module.exports = {
  id:          'carte-territoire-en',
  title:       'The Map Is Not the Territory',
  category:    'Epistemology',
  tagline:     "Our models of the world are not the world.",
  description: "Aphorism by Alfred Korzybski: any representation (map, model, concept) is a simplification of reality. Mistaking it for reality leads to error.",
  ...
  render(ctx) {
    ...
    <text x="382" y="208" text-anchor="middle"
          ...
          letter-spacing="2.5" fill="${p.muted}" opacity="0.50">THE MAP</text>
    <text x="820" y="208" text-anchor="middle"
          font-family="Ubuntu, sans-serif" font-weight="500" font-size="14"
          letter-spacing="2.5" fill="${p.gold}" opacity="0.55">THE TERRITORY</text>`;

    const gx0 = 185, gx1 = 575, gy0 = 230, gy1 = 840;
    ...
    <text x="382" y="872" text-anchor="middle"
          ...
          letter-spacing="1" fill="${p.muted}" opacity="0.38">simplified, labelled, readable</text>
    <text x="820" y="872" text-anchor="middle"
          font-family="Ubuntu, sans-serif" font-weight="400" font-size="13"
          letter-spacing="1" fill="${p.gold}" opacity="0.50">complex, nuanced, resistant</text>`;
