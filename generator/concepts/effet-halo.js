...
module.exports = {
  ...
  tagline:     "Un trait positif teinte toute la perception d'une personne.",
  ...
  render(ctx) {
    ...
    <text x="${cx}" y="${cy + 12}" text-anchor="middle"
          font-family="Ubuntu, sans-serif" font-weight="700" font-size="14"
          letter-spacing="1.5" fill="${p.gold}" opacity="0.85">POSITIF</text>
    ...
    const attrs = ['Compétence', 'Intelligence', 'Fiabilité', 'Honnêteté', 'Leadership', 'Créativité'];
    ...
    <text x="600" y="858" text-anchor="middle"
          ...
          letter-spacing="1.5" fill="${p.muted}" opacity="0.32">Un seul trait positif colore la perception de tous les autres.</text>`;
