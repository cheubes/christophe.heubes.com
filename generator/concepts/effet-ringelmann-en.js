...
module.exports = {
  id:          'effet-ringelmann-en',
  title:       'Ringelmann Effect',
  category:    'Psychology & Behaviour',
  tagline:     "The larger the group, the less each member contributes.",
  ...
  render(ctx) {
    ...
    const data = [
      { n: 1, label: '1 person',  effort: 100, col: p.gold,  fillOp: '0.32', op: '0.80' },
      { n: 2, label: '2 people',  effort: 93,  col: p.gold,  fillOp: '0.20', op: '0.60' },
      { n: 4, label: '4 people',  effort: 77,  col: p.muted, fillOp: '0.28', op: '0.50' },
      { n: 8, label: '8 people',  effort: 49,  col: p.muted, fillOp: '0.38', op: '0.68' },
    ];
    ...
    <text x="${axLabelX}" y="${axLabelY + 5}" text-anchor="middle"
          ...
          transform="rotate(-90, ${axLabelX}, ${axLabelY})">individual effort</text>`;
    ...
    <text x="600" y="860" text-anchor="middle"
          font-family="Ubuntu, sans-serif" font-weight="400" font-size="13"
          letter-spacing="1.5" fill="${p.muted}" opacity="0.32">Diffused responsibility reduces each person's effort.</text>`;
