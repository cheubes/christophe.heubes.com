...
module.exports = {
  ...
  render(ctx) {
    ...
    <text x="600" y="860" text-anchor="middle"
          ...
          letter-spacing="1.5" fill="${p.gold}" opacity="0.42">growing complexity</text>`;
